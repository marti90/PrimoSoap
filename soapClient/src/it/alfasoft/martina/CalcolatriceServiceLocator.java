...
public class CalcolatriceServiceLocator extends org.apache.axis.client.Service implements it.alfasoft.martina.CalcolatriceService {
    ...
    private java.lang.String Calcolatrice_address = "http://localhost:8086/primoSoap/services/Calcolatrice";
    ...
    public it.alfasoft.martina.Calcolatrice getCalcolatrice(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.alfasoft.martina.CalcolatriceSoapBindingStub _stub = new it.alfasoft.martina.CalcolatriceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.alfasoft.martina.Calcolatrice.class.isAssignableFrom(serviceEndpointInterface)) {
                it.alfasoft.martina.CalcolatriceSoapBindingStub _stub = new it.alfasoft.martina.CalcolatriceSoapBindingStub(new java.net.URL(Calcolatrice_address), this);
                _stub.setPortName(getCalcolatriceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://martina.alfasoft.it", "CalcolatriceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://martina.alfasoft.it", "Calcolatrice"));
        }
